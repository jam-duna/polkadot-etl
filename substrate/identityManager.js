    ...
    */
    ...
    async dump_identity() {
        ...
        */
        ...
        let cmd1 = `bq load --project_id=substrate-etl --max_bad_records=10 --source_format=NEWLINE_DELIMITED_JSON --replace=true polkadot_analytics.identity gs://substrate_identity/* /root/go/src/github.com/colorfulnotion/polkaholic-pro/substrate/schema/substrateetl/identity.json`
        console.log(cmd0)
        console.log(cmd1)
        await exec(cmd0);
        await exec(cmd1);
